		...
		<form id="wca-dialog">
			...
			<div id="wca-dialog-content">
				<div id="wca-dialog-inner">
					...
					<dl style = "display: none;" id="wca-detail-id">
						<dt><?php _e( 'Appointment_id:', 'woocommerce-appointments' ); ?></dt>
						<dd>-</dd>
					</dl>
					...
					<dl id="wca-detail-staff">
						<dt><?php _e( 'Counselor:', 'woocommerce-appointments' ); ?></dt>
						<dd>-</dd>
					</dl>
					<dl id="wca-detail-date">
						<dt><?php _e( 'Date:', 'woocommerce-appointments' ); ?></dt>
						<dd>-</dd>
					</dl>
					<dl id="wca-detail-time">
						<dt><?php _e( 'Time:', 'woocommerce-appointments' ); ?></dt>
						<dd>-</dd>
					</dl>
			...
			<div id="wca-dialog-footer">
				...
				<div id="wca-dialog-update" class="button-group">
					...
					<button type="submit" id="wca-dialog-reschedule" name="wca-dialog-reschedule" class="reschedule_appointment button button-primary">
						<?php _e( 'Reschedule Appointment', 'woocommerce-appointments' ); ?>
					</button>
...
<script type="text/javascript">
	jQuery(function() {
		...
		jQuery( document ).on( 'click', '.appointments li', function(e) {
			...
			var detail_appointment_id = jQuery( '#wca-detail-id dd' );
			...
			//** DETAILS: start
				...
				if ( appointment_product ) {
					...
					product_title += appointment_product;
				...
				// Staff
				if ( appointment_id ) {
					detail_appointment_id.html( appointment_id );
				}
