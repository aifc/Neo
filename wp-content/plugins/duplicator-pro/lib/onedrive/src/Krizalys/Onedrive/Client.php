...
class Client
{
    ...
    public function uploadFileChunk($sourcePath,$path = null,$resumable = null, $max_worker_time = 15,$server_load_delay = 0,$offset = 0)
    {
        $start_time = time();
        $time_passed = 0;
        $completed = false;
    ...
    {
        $path = (null !== $driveItemId) ? 'drive/items/'.$driveItemId : 'drive/special/approot';
    ...
    {
        $path = (null !== $driveItemId) ? 'drive/items/'.$driveItemId.'/children' : 'drive/special/approot/children';
