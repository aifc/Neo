...
//SITE-INACTIVE
	...
	$license_status_style	 = 'color:#dd3d36;';
	$global					 = DUP_PRO_Global_Entity::get_instance();
	$license_status_text	 = ($global->license_no_activations_left) ? DUP_PRO_U::__('Status: Inactive (out of site licenses)') : DUP_PRO_U::__('Status: Inactive');
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<?php if ($license_status == DUP_PRO_License_Status::Valid && $is_localhost) :?>
