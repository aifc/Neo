...
<p class="item">
    Bug fix release. See <a href="https://snapcreek.com/duplicator/docs/changelog/" target="_blank">changelog</a> for details
</p>
...
<p class="item">
	<?php
		...
		DUP_PRO_U::_e("<small>Upload installer/archive on existing site and reuses sites's database. <b>No Database Creation Required!</b></small>");
	?>
</p>
...
<div style="padding:0 0 0 30px">
	...
	<p class="item">
		<?php
			$brandingLink = "admin.php?page=duplicator-pro-storage&tab=storage&inner_page=edit";
			DUP_PRO_U::_e("<sup class='new-badge'>new</sup> <b>OneDrive Storage</b> - Use Microsoft OneDrive to store and manage packages. <br/>");
			DUP_PRO_U::_e("<small>Go to <a href='{$brandingLink}'>Storage > Add New</a> to setup.</small>");
		?>
	</p>
