				...
				<div id="dup-file-filter-items">
					...
					<div class='dup-quick-links'>
						...
						<?php if (! empty($content_path)) :?>
							<a href="javascript:void(0)" onclick="DupPro.Pack.AddExcludePath('<?php echo rtrim(WP_CONTENT_DIR, '/'); ?>')">[<?php DUP_PRO_U::_e("wp-content") ?>]</a>
						<?php endif; ?>
...
jQuery(document).ready(function($) 
{
	...
	$('#mu-exclude-btn').click(function() {
        var include_all_count = $('#mu-include option').length,
            include_selected_count = $('#mu-include option:selected').length;
