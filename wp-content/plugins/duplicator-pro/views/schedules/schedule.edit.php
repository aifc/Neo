...
<table class="form-table">
    ...
    <tr valign="top">
        ...
        <td>
			...
			<a href="admin.php?page=duplicator-pro-templates" style="margin-top:2px" class="button button-small" title="<?php DUP_PRO_U::_e("List All Templates") ?>" target="edit-template">
...
<script>
    jQuery(document).ready(function ($) {
		...
		DupPro.Schedule.EditTemplate = function () {
			...
			var url = '?page=duplicator-pro-templates&tab=templates&inner_page=edit&package_template_id=' + templateID;
