<div class="options_group wc-appointments-selector">
    <p class="form-field">
        <label for="storewide_type"><?php _e('Enable for', 'woocommerce-appointments'); ?></label>
        <select name="meta[storewide_type]" id="storewide_type" class="">
            <option value="all" <?php selected( $storewide_type, 'all' ); ?>><?php _e('All products', 'woocommerce-appointments'); ?></option>
            <option value="products" <?php selected( $storewide_type, 'products' ); ?>><?php _e('A specific product', 'woocommerce-appointments'); ?></option>
            <option value="categories" <?php selected( $storewide_type, 'categories' ); ?>><?php _e('A specific category', 'woocommerce-appointments'); ?></option>
        </select>
    ...
    <div class="non-signup reminder hideable <?php do_action('fue_form_product_tr_class', $email); ?> product_tr">
        <p class="form-field">
            <label for="product_ids"><?php _e('Product', 'woocommerce-appointments'); ?></label>
            <?php
            ...
            <input
                ...
                data-placeholder="<?php _e( 'Search for a product&hellip;', 'woocommerce-appointments' ); ?>"
        ...
        <p class="form-field product_include_variations" style="<?php echo $display; ?>">
            ...
            <label for="include_variations" class="inline"><?php _e('Include variations', 'woocommerce-appointments'); ?></label>
        </p>
    </div>

    <div class="non-signup reminder hideable <?php do_action('fue_form_category_tr_class', $email); ?> category_tr">
        <p class="form-field">
            <label for="category_id"><?php _e('Category', 'woocommerce-appointments'); ?></label>

            <select id="category_id" name="category_id" class="select2" data-placeholder="<?php _e('Search for a category&hellip;', 'woocommerce-appointments'); ?>">
                <option value="0"><?php _e('Any Category', 'woocommerce-appointments'); ?></option>
                <?php
