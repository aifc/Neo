...
class WC_Appointments_Integration_WCFUE {
    ...
    public function register_email_type( $types ) {
        ...
        $duration_units = method_exists( 'Follow_Up_Emails', 'get_schedule_units' ) ? Follow_Up_Emails::get_schedule_units() : Follow_Up_Emails::$durations;
    ...
    public function appointment_created( $appointment_id ) {
        ...
        if ( $appointment->get_status() == 'in-cart' ) {
            return;
        }
