...
<tr>
	...
	<td class="range_type">
		<div class="select wc_appointment_pricing_type">
			<select name="wc_appointment_pricing_type[]">
				...
				<option value="quant" <?php selected( $pricing['type'], 'quant' ); ?>><?php _e( 'Quantity count', 'woocommerce-appointments' ); ?></option>
	...
	<td class="range_from">
		<div class="appointments-datetime-select-from">
			...
			<div class="from_time">
				<input type="time" class="time-picker" name="wc_appointment_pricing_from_time[]" value="<?php
			...
			<div class="from">
				<input type="number" step="1" name="wc_appointment_pricing_from[]" value="<?php
	...
	<td class="range_to">
		<div class='appointments-datetime-select-to'>
			...
			<div class="to_time">
				<input type="time" class="time-picker" name="wc_appointment_pricing_to_time[]" value="<?php
	...
	<td>
		<div class="price_wrap">
			...
			<input type="number" step="0.01" name="wc_appointment_pricing_base_cost[]" value="<?php
			if ( ! empty( $pricing['base_cost'] ) ) {
				echo $pricing['base_cost'];
			}
			?>" placeholder="0" />
			<?php do_action( 'woocommerce_appointments_after_appointment_pricing_base_cost', $pricing, $post->ID ); ?>
		</div>
	</td>
	<td>
		<div class="price_wrap">
			...
			<input type="number" step="0.01" name="wc_appointment_pricing_cost[]" value="<?php
			if ( ! empty( $pricing['cost'] ) ) {
				echo $pricing['cost'];
			}
			?>" placeholder="0" />
			<?php do_action( 'woocommerce_appointments_after_appointment_pricing_cost', $pricing, $post->ID ); ?>
		</div>
	</td>
	<td class="remove">&nbsp;</td>
</tr>
