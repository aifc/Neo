...
<tr>
	...
	<td class="range_from">
		<div class="appointments-datetime-select-from">
			...
			<div class="from_time">
				<input type="time" class="time-picker" name="wc_appointment_availability_from_time[]" value="<?php
	...
	<td class="range_to">
		<div class='appointments-datetime-select-to'>
			...
			<div class="to_time">
				<input type="time" class="time-picker" name="wc_appointment_availability_to_time[]" value="<?php
	...
	<?php if ( 'product' === $current_screen->id ) { ?>
		<td class="range_capacity">
			...
			if ( isset( $availability['qty'] ) && ! empty( $availability['qty'] ) ) {
				echo $availability['qty'];
			}
			?>" step="1" min="1" placeholder="<?php _e( 'N/A', 'woocommerce-appointments' ); ?>" style="width: 6em;">
		</td>
	<?php } ?>
	<td class="range_appointable">
		<div class="select">
			<select name="wc_appointment_availability_appointable[]">
				<option value="yes" <?php selected( isset( $availability['appointable'] ) && 'yes' == $availability['appointable'], true ); ?>><?php _e( 'Yes', 'woocommerce-appointments' ); ?></option>
				<option value="no" <?php selected( isset( $availability['appointable'] ) && 'no' == $availability['appointable'], true ); ?>><?php _e( 'No', 'woocommerce-appointments' ); ?></option>
			</select>
		</div>
	</td>
	<td class="remove">&nbsp;</td>
