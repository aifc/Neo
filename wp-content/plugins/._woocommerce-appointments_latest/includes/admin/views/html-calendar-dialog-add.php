						...
						<dd>
							<select id="appointable_product_id" name="appointable_product_id" class="chosen_select" style="width:300px">
								...
								<?php foreach ( WC_Appointments_Admin::get_appointment_products() as $product ) : ?>
									<option value="<?php echo $product->get_id(); ?>" data-duration="<?php echo $product->get_duration(); ?>" data-duration-unit="<?php echo $product->get_duration_unit(); ?>" ><?php echo $product->get_title(); ?></option>
								<?php endforeach; ?>
							</select>
						</dd>
					</dl>
