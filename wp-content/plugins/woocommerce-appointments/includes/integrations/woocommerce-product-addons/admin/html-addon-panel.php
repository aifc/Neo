<div id="product_addons_data" class="panel woocommerce_options_panel wc-metaboxes-wrapper">
	...
	<div class="toolbar">
		<button type="button" class="button add_new_addon button-primary"><?php _e( 'New Addon Group', 'woocommerce-appointments' ); ?></button>
    ...
    <div class="options_group">
        ...
        <input id="_product_addons_exclude_global" name="_product_addons_exclude_global" class="checkbox" type="checkbox" value="1" <?php checked( get_post_meta( $post->ID, '_product_addons_exclude_global', true ), 1 ); ?>/><span class="description"><?php _e( 'Check this to exclude this product from all Global Addons', 'woocommerce-appointments' ); ?></span>
		</p>
	</div>
	<?php endif; ?>
</div>
