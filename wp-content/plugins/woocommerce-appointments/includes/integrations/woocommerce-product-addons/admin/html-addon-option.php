...
?>
<tr>
	<td><input type="text" name="product_addon_option_label[<?php echo $loop; ?>][]" value="<?php echo esc_attr( $option['label'] ); ?>" placeholder="<?php _e( 'Default Label', 'woocommerce-appointments' ); ?>" /></td>
	...
	<?php do_action( 'woocommerce_product_addons_panel_body_option', isset( $addon ) ? $addon : '', $loop, $option, isset( $post ) ? $post : '', $product_addons ); ?>
