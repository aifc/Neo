...
<tr>
	...
	<td class="range_capacity">
		<input type="number" name="wc_appointment_availability_qty[]" id="wc_appointment_availability_qty" value="<?php if ( isset( $availability['qty'] ) && ! empty( $availability['qty'] ) ) echo $availability['qty']; ?>" step="1" min="1" placeholder="<?php _e( 'N/A', 'woocommerce-appointments' ); ?>" style="width: 6em;">
	</td>
