<div id="appointments_staff" class="woocommerce_options_panel panel wc-metaboxes-wrapper">
	...
	<div class="options_group" id="staff_options">
		...
		<?php woocommerce_wp_text_input( array( 'id' => '_wc_appointment_staff_label', 'placeholder' => __( 'Providers', 'woocommerce-appointments' ), 'label' => __( 'Label', 'woocommerce-appointments' ), 'desc_tip' => true, 'description' => __( 'The label shown on the frontend if the staff is customer defined.', 'woocommerce-appointments' ) ) ); ?>

		<?php woocommerce_wp_select( array(
			'id' => '_wc_appointment_staff_assignment',
			'label' => __( 'Staff selection', 'woocommerce-appointments' ),
			'value' => get_post_meta( $post_id, '_wc_appointment_staff_assignment', true ),
			'options' => array(
