...
= 1.4.3 =
* Fixed JS issue with script not returning img src param

= 1.4.2 = 
* Fixed security issue #2 / added user role verification

= 1.4.1 = 
* Fixed security issue #1 

= 1.4 = 
* Major Update: Fixed saving settings issues, updated settings area and several functions. Ready for WP 4.7

= 1.3.2 = 
* Fixed mixed content warning (jQuery src) if site is running on https

= 1.3.1 = 
* Fixed jQuery Error in Login Page's Blogurl

= 1.3 = 
* Minor changes

= 1.2.9 = 
* Fixed PHP Notices in Debug Mode, optimized several code snippets
