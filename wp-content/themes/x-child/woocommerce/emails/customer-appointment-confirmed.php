...
<p><?php _e( 'Your appointment with Neo has been confirmed. The details of your appointment are shown below.', 'woocommerce-appointments' ); ?></p>
...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee; margin:0 0 16px;" border="1" bordercolor="#eee">
	<tbody>
		...
		<?php require( __DIR__ . '/client-appointment-instructions.php'); ?>
	</tbody>
</table>
