 ...
 * Copied from bps profile search plugin
...
<?php
	...
	foreach ($F->fields as $f)
	{
		...
		case 'textbox':
		case 'textarea':
			echo "<input class='filter-width' placeholder='$f->label' type='text' name='$f->code' id='$f->code' value='$f->value'>\n";
			break;
		...
		case 'radio':
		case 'checkbox':
			echo "<select class='filter-width' name='$f->code' id='$f->code'>\n";
			echo "<option  value=''>$f->label</option>\n";
